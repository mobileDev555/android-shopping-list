    ...
    public void processItem(ProductItem item)
    {
        ...
        checkbox.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                productService.saveOrUpdate(item, cache.getListId()).doOnError(Throwable::printStackTrace).subscribe();
                if ( checkbox.isChecked() && cache.getStatisticsEnabled() ) {
                    statisticsService.saveRecord(item).doOnError(Throwable::printStackTrace).subscribe();
                }
...
//        });
    ...
    private void updateVisibilityFormat(ProductItem item)
    {
        ...
        if ( item.isChecked() )
        {
            ...
            productNameTextView.setBackgroundResource(R.drawable.strick);
            quantityTextView.setTextColor(grey);
            quantityTextView.setBackgroundResource(R.drawable.strick);
...
//            productQuantityTextView.setPaintFlags(productQuantityTextView.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
        ...
        else
        {
            ...
            productNameTextView.setBackgroundResource(R.drawable.strick_none);
            quantityTextView.setTextColor(black);
            quantityTextView.setBackgroundResource(R.drawable.strick_none);
//            productNameTextView.setPaintFlags(productNameTextView.getPaintFlags() & (~Paint.STRIKE_THRU_TEXT_FLAG));
//            productQuantityTextView.setPaintFlags(productQuantityTextView.getPaintFlags() & (~Paint.STRIKE_THRU_TEXT_FLAG));
        }
