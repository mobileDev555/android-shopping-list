...
import privacyfriendlyshoppinglist.secuso.org.privacyfriendlyshoppinglist.ui.deleteproducts.ShareProductsActivity;
    ...
    protected final void onCreate(final Bundle savedInstanceState) {
        ...
        sort_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SortProductsDialog sortProductsDialog = SortProductsDialog.newInstance(ProductsActivity.this, listId);
                sortProductsDialog.show(ProductsActivity.this.getFragmentManager(), "SortDialog");
            }
        });
...
//                CancelSearchOnClick.performClick();
                Intent intent = new Intent(ProductsActivity.this, DeleteProductsActivity.class);
        ...
        share_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProductsActivity.this, ShareProductsActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                intent.putExtra(MainActivity.LIST_ID_KEY, listId);
                ProductsActivity.this.startActivity(intent);
            }
