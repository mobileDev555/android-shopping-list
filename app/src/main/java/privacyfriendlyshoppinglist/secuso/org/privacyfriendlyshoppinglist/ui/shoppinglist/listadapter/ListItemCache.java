...
public class ListItemCache
{
    ...
    private ImageButton showShareImageButton;
    ...
    public ListItemCache(View parent)
    {
        ...
        showShareImageButton = (ImageButton) parent.findViewById(R.id.share_button_list);
    ...
    public ImageButton getShowShareImageButton()
    {
